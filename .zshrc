...
export ZSH=/Users/cao/.oh-my-zsh
...
plugins=(brew git aws common-aliases compleat osx encode64 fasd gitfast npm pip sbt scala sudo zsh-syntax-highlighting)
...
alias aria2rpc='aria2c --conf-path=/Users/cao/.aria2/aria2.conf -D'
alias aria2rpc='aria2c --conf-path= -D'
alias aria2rpc='aria2c --conf-path=/Users/cao/.aria2/aria2.conf -D'
alias ccis="ssh jingchao@login.ccs.neu.edu -t 'cd 5700/network-project4; bash --login'"
alias sshmount="sshfs jingchao@login.ccs.neu.edu:5700/network-project4 network-project4 -o auto_cache,reconnect,defer_permissions,noappledouble,no_readahead,nolocalcaches,compression=no,Ciphers=arcfour"
alias ec2="ssh jingchao@ec2-54-198-77-2.compute-1.amazonaws.com"
alias myserver='ssh root@174.138.68.37'
...
export PATH=$PATH:/Users/cao/Library/Python/2.7/bin
